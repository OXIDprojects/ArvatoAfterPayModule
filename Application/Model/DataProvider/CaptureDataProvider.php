 ...
 * @codeCoverageIgnore
 */
class CaptureDataProvider extends \OxidProfessionalServices\ArvatoAfterpayModule\Application\Model\DataProvider\DataProvider
{
    /**
    ...
    public function getDataObject(\OxidEsales\Eshop\Application\Model\Order $oxOrder, array $aOrderItems = null)
    {
        ...
        $dataObject = oxNew(\OxidProfessionalServices\ArvatoAfterpayModule\Application\Model\Entity\CaptureEntity::class);
