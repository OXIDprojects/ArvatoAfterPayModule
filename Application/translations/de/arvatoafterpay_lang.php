...
$aLang = [
    ...
    "AFTERPAY_LEGAL_INVOICE_DEBITNOTE"            => '<input id="checkAfterPayAgbTop" type="checkbox" name="ord_afterpay_agb" value="1">Ich habe die <a href="https://www.afterpay.de/agb" target="_new" style="text-decoration:underline">Allgemeinen Geschäftsbedingungen</a> und <a href="https://www.afterpay.de/datenschutz" target="_new" style="text-decoration:underline">Datenschutzbestimmungen</a> von AfterPay gelesen und akzeptiere diese.',

    "AFTERPAY_LEGAL_INSTALLMENT"                  => '<hr>
                                                      <p>Bitte klicken Sie <a href="##READMORELINK##" target="_new" style="text-decoration:underline">hier</a> für einen Tilgungsplan anhand beispielhafter Gesamtbeträge. Sie müssen keine Versicherung oder andere Sicherheiten stellen.</p>
                                                      <!--SECCISTART-->
                                                      ...
                                                      Ich habe die <a href="https://www.afterpay.de/agb" target="_new" style="text-decoration:underline">Allgemeinen Geschäftsbedingungen</a> und <a href="https://www.afterpay.de/datenschutz" target="_new" style="text-decoration:underline">Datenschutzbestimmungen</a> von AfterPay
